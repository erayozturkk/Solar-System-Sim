...
void main()
{
	...
	vec3 viewDir = normalize(-fragPos); // View direction from the fragment position
	vec3 reflectDir = reflect(-lightdir, normal); // Reflect the light direction about the normal
